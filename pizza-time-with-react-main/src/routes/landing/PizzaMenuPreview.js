  ...
  return (
    <article className="section-4 flex-container flex-column">
      <section className="section-4-info txt-center">
        <h2 className="pop-font txt-white">Sıcak Pizzalar</h2>
        <p className="section-description">
          Pizza Love, pizza endüstrisinin lideri konumunda ve sürekli olarak
          pizza dışında daha fazlasını sunuyor. Peynir, et, tavuk ve sebzelerle
          dolu en yeni menü seçeneklerimize göz atın!
        </p>
      </section>
