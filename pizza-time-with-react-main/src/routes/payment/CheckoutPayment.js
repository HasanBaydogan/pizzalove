      ...
      {submit && Object.keys(formError).length === 0 ? (
        <article className="success-payment">
          <section className="success-payment-title">
            <h2>Yemeğiniz yolda!</h2>
            <p>
              Siparişiniz için teşekkür ederiz. Siparişiniz teslim edildiğinde
              sipariş durumunuzu güncelleyeceğiz. restoran bunu doğruluyor.{" "}
            </p>
          </section>
          <img src={Tick} alt="" aria-hidden="true" />
          <section className="payment-details">
            <p>
              Ödenen miktar: <span>{totalPayment} $</span>
            </p>
            <p>
              İşlem kimliği: <span>{transactionId}</span>
            </p>
            <h3>Tahmini teslimat süresi: 24 dakika.</h3>
          </section>
