...
const Register = ({ activateLoginModal }) => {
  ...
  return (
    <main className="register-main">
      <h2>
        {submit && Object.keys(formError).length === 0 ? "Başarılı!" : "Kayıt"}
      </h2>
      {loading ? (
        ...
        <section className="registration-success">
          <p className="form-submit-msg">
            Artık giriş yapabilir ve sipariş verebilirsiniz!
          </p>
          <button
        ...
        <form className="registration-form" onSubmit={handleSubmit}>
          {registrationFail ? (
            <p className="registration-input-err">
              Görünüşe göre bu e-posta çoktan kaydedilmiş!
            </p>
          ) : null}
          ...
          <p className="terms-warning">
            Kaydol'a tıklayarak Şartlarımızı, Veri Politikamızı ve Çerezleri
            kabul etmiş olursunuz. Politika. Bizden bir e-posta bildirimi
            alabilir ve aşağıdakileri seçebilirsiniz İstediğin zaman
            çıkabilirsin.
          </p>
